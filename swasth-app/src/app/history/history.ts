...
export class HistoryPage implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.chatService.getHistory()
      .pipe(
        // Fail fast after 10 s instead of hanging forever
        timeout(10000),
        catchError((err: any) => {
      ...
      .subscribe((res: any) => {
        ...
        this.cdr.detectChanges();   // force change detection regardless of zone
      });
  }

  /** Postgres may return JSONB as a string or already parsed — handle both. */
